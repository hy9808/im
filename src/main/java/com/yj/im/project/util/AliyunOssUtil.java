...
public class AliyunOssUtil {
     ...
     * @return
     */
    private String createBucketName(OSSClient ossClient, String bucketName) {
        //存储空间
     ...
     * @param bucketName 存储空间
     */
    private void deleteBucket(OSSClient ossClient, String bucketName) {
     ...
     */
    private String uploadObject2OSS(OSSClient ossClient, MultipartFile file, String bucketName, String folder) throws Exception {
    ...
    private String getContentType(String fileName) {
        ...
        if (".mpeg4".equalsIgnoreCase(fileExtension)) {
            return "video/mpeg4";
        }
     ...
     * @return
     */
    private URL getUrl(OSSClient ossClient, String fileName)  {
